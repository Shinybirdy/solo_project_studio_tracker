/** Handles all authentication requests including login and log out
* @module routes/auth
*/
...
*
* NO___We are using the Google Calendar API in this example.
...
router.get('/google/callback', passport.authenticate( 'google',
  {
    successRedirect: '/private', // take user to their private data
    failureRedirect: '/', //take user home to try again
  })
);
/** GET auth - Is request coming from logged in user?
* @return object with status ( true or false) and, if true, user's name
*/
...
/** GET  /auth/logout logs out user by removing passport session
* @return 200 - OK
*/
router.get('/logout', function (req, res) {
  req.logout();
  res.sendStstus(200); //sweet success!
});
